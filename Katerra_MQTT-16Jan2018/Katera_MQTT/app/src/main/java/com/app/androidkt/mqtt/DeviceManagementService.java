...
public class DeviceManagementService extends Service {
    ...
    private final IBinder binder = new com.app.androidkt.mqtt.DeviceManagementService.LocalBinder();
    ...
    public void onCreate() {
        ...
        mqttAndroidClient.setCallback(new MqttCallbackExtended() {
            ...
            public void messageArrived(String s, MqttMessage mqttMessage) throws Exception {
                ...
                if(s.contains("DEV_REG_RES"))
                {
                    System.out.println("=================111"+mqttMessage.toString());
                    callBacks.MessageArrivedFrom_DEV_REG_RES(new JSONObject(mqttMessage.toString()));
                }
                if(s.contains("DEV_NOTIFY_RES")|| s.contains("DEV_PARAM_RES"))
                {
    ...
    class LocalBinder extends Binder {
        DeviceManagementService getService() {
