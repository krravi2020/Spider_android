...
public class HeartBeatService extends Service{
    ...
    private final IBinder binder = new com.app.androidkt.mqtt.HeartBeatService.LocalBinder();
    ...
    public void onCreate() {
        ...
        mqttAndroidClient.setCallback(new MqttCallbackExtended() {
            ...
            public void messageArrived(String s, MqttMessage mqttMessage) throws Exception {
                ...
                System.out.println("Heart Beat Service================"+mqttMessage.toString());
                Log.d("HearBeat Service","From +  "+s+"   "+mqttMessage.toString());
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        mqttAndroidClient.setCallback(new MqttCallbackExtended() {
            ...
            public void messageArrived(String s, MqttMessage mqttMessage) throws Exception {
                ...
                Log.d("HearBeat Service","From +  "+s+"   "+mqttMessage.toString());
                setMessageNotification(s, new String(mqttMessage.getPayload()));
                /*if(s.equalsIgnoreCase("GW_HB_RES"))
                {*/
                callBacks.MessageArrivedFrom_GW_HB_RES_Topic(new JSONObject(mqttMessage.toString()));
                //}
